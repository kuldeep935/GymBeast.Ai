...
?>
    ...
    <h2 class="section-title">🎯 Create Your Personalized Fitness Plan</h2>
    <form method="POST" class="plan-section">
        <div class="plan-card">
        ...
        <div class="plan-card">
            ...
            <textarea id="conditions" name="conditions" rows="3" placeholder="Any health conditions or limitations we should know about?"></textarea>
        </div>
        <div style="text-align: center; margin-top: 20px;">
            <button type="submit" style="background: var(--primary-color); color: white; border: none; padding: 12px 30px; font-size: 16px; border-radius: 8px; cursor: pointer;">
                Generate My Plan
            </button>
        </div>
    </form>
